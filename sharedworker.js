...
onmessage = function ({ data }) {
    ...
    for (
        ...
        for (
            ...
            let val = julia(new Complex(x, y), new Complex(C[0], C[1]));
            sharedArray[index + 0] = val / ITER_CONST * 255;
            sharedArray[index + 1] = val / ITER_CONST * 255;
            sharedArray[index + 2] = val / ITER_CONST * 255;
